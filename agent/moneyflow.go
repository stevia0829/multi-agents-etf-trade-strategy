...
//
// 角色定位：扮演"游资 / 主力资金行为分析师"——
//   - 风格取自保罗·都铎·琼斯 (Paul Tudor Jones) 的"资金动向先于价格" 与
//     马蒂·施瓦茨 (Marty Schwartz) 的"短线资金博弈" 思路；
//   - 关注量价行为而非财报基本面，专门捕捉"谁在偷偷买、谁在悄悄卖"。
//
// 设计说明：
//
...
//
// 算法（Tudor Jones 的"跟随聪明钱"原则）：
//   - 近 5 日量价齐升 → 资金净流入（估算正值）
//   - 量比放大 + 收阴 → 资金分歧 / 派发（估算负值，警惕"假突破真出货"）
